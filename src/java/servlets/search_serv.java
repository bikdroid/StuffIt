 ...
 * @author Chitra
 */
@WebServlet(name = "search_serv", urlPatterns = {"/search_serv"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  { 
            List<Recipe> c=new ArrayList<Recipe>();
              ...
              c= x.getRecipesForIngredients(list);
              System.out.println("got recipes" + c.toString());
            HttpSession session = request.getSession();
            session.setAttribute("recipesList", c);
